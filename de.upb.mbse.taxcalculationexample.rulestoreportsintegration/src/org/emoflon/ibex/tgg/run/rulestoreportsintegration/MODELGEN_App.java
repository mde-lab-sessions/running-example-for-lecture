...
public class MODELGEN_App extends MODELGEN {
	...
	public static void main(String[] args) throws IOException {
		...
		stop.setMaxRuleCount("CalculationResultsToReportingJobRule", 1);
		stop.setMaxRuleCount("SteuerInlaenderToRecipientRule", 3);
		stop.setMaxRuleCount("DepotToReportRule", 4);
